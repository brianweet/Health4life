...
(function ($) {
    ...
    Calendar.prototype._update_month_year = function () {
        ...
        var self = this;
        var activecell = 0;
        var downbox = $(document.createElement('div')).attr('id', 'cal-day-box').attr('style','opacity:0').html('<i class="icon-chevron-down glyphicon glyphicon-chevron-down"></i>');
    ...
    Calendar.prototype.getEventsBetween = function (start, end) {
        ...
        $.each(this.options.events, function () {
            if ((parseInt(this.start.substr(6)) < end || this.start.substr(6) == null) && (parseInt(this.end.substr(6)) >= start || this.end.substr(6) == null)) {
                events.push(this);
            }
        });
        return events;
